...
![Updated](https://img.shields.io/badge/updated-2026--08--09-brightgreen?style=flat-square)&nbsp;![Records](https://img.shields.io/badge/records-2.5M-blue?style=flat-square)&nbsp;[![Rebrowser](https://img.shields.io/badge/full%20dataset-rebrowser.net-orange?style=flat-square)](https://rebrowser.net/products/datasets/autotrader)
...
> **2,489,243** total records from 2025-11-16 to 2026-08-02, **up to 30,000** rows in this sample (1.2% of full dataset).
...
[Listings with Pricing Data](https://rebrowser.net/products/datasets/autotrader/car-listings/views/listings-with-pricing) — 2,487,511 records

↳ `[{"field":"salePrice","op":"gt","value":0},{"sort":"salePrice DESC"}]`

[Certified Pre-Owned Listings](https://rebrowser.net/products/datasets/autotrader/car-listings/views/certified-preowned-listings) — 319,738 records

↳ `[{"field":"listingType","op":"is","value":"Certified"},{"sort":"salePrice DESC"}]`

[New Vehicle Listings](https://rebrowser.net/products/datasets/autotrader/car-listings/views/new-vehicle-listings) — 153,249 records

↳ `[{"field":"listingType","op":"is","value":"New"},{"sort":"msrp DESC"}]`

[Used Vehicle Listings](https://rebrowser.net/products/datasets/autotrader/car-listings/views/used-vehicle-listings) — 1,997,388 records

↳ `[{"field":"listingType","op":"is","value":"Used"},{"sort":"salePrice DESC"}]`

[Premium and Sponsored Listings](https://rebrowser.net/products/datasets/autotrader/car-listings/views/premium-listings) — 1,226,398 records
